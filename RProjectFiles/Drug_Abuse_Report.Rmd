...
**Due to the sensitive nature of this survey, no attempts were made or shall be made to connect responses to respondents. If any connections are made, report them to CBHSQ and SAMHDA (samhda-support@icpsr.umich.edu)**
...
**There were a total of 55,160 (with a response rate of 84%) responces, each of whom were paid $30 for their time.**
...
When predicting if a respondent has ever had a cigarette using classification algorithms, ALCTRY, age at which the respondent first had alcohol, had high confidence correlation with the respondent ever having a cigarette. Namely, the younger a person had alcohol for the first time, the more likely it is that they have had a cigarette. In fact, another alcohol variable, ALCYRTOT, the amount of alcohol the person has had in the past year, increases along with cigarette usage and is the top confidence variable. 
